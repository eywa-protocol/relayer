...
if [[ "$OSTYPE" == "darwin"* ]];then
  ...
  # init nodes
  docker-compose -f ../docker-compose-macos.yaml run --rm --no-deps  node1 ./bridge -mode init -cnf bootstrap.env
  docker-compose -f ../docker-compose-macos.yaml run --rm --no-deps  node2 ./bridge -mode init -cnf bootstrap.env
  docker-compose -f ../docker-compose-macos.yaml run --rm --no-deps  node3 ./bridge -mode init -cnf bootstrap.env
  docker-compose -f ../docker-compose-macos.yaml run --rm --no-deps  node4 ./bridge -mode init -cnf bootstrap.env
  docker-compose -f ../docker-compose-macos.yaml run --rm --no-deps  node5 ./bridge -mode init -cnf bootstrap.env
  docker-compose -f ../docker-compose-macos.yaml run --rm --no-deps  node6 ./bridge -mode init -cnf bootstrap.env
  docker-compose -f ../docker-compose-macos.yaml run --rm --no-deps  node7 ./bridge -mode init -cnf bootstrap.env
  # up nodes containers
  ...
  # init nodes
  docker-compose -f ../docker-compose.yaml run --rm --no-deps  node1 ./bridge -mode init -cnf bootstrap.env
  docker-compose -f ../docker-compose.yaml run --rm --no-deps  node2 ./bridge -mode init -cnf bootstrap.env
  docker-compose -f ../docker-compose.yaml run --rm --no-deps  node3 ./bridge -mode init -cnf bootstrap.env
  docker-compose -f ../docker-compose.yaml run --rm --no-deps  node4 ./bridge -mode init -cnf bootstrap.env
  docker-compose -f ../docker-compose.yaml run --rm --no-deps  node5 ./bridge -mode init -cnf bootstrap.env
  docker-compose -f ../docker-compose.yaml run --rm --no-deps  node6 ./bridge -mode init -cnf bootstrap.env
  docker-compose -f ../docker-compose.yaml run --rm --no-deps  node7 ./bridge -mode init -cnf bootstrap.env
  # up nodes containers
